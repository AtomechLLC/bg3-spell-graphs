...
.fsc{{display:inline-flex;align-items:center;gap:7px;border:1px solid var(--line);
  border-radius:999px;padding:4px 12px;font:500 11px "IBM Plex Mono",monospace;color:var(--muted);
  text-decoration:none;letter-spacing:.05em;margin-bottom:22px}}
.fsc:hover{{border-color:var(--accent);color:var(--accent)}}
</style>
<main>
