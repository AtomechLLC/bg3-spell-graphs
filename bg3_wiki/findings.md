...
Which Baldur's Gate 3 spells are mostly the same spell. Of the **211 distinct spells** reachable through class progressions, **78 fall into 19 families** — and that's *before* counting Larian's own admission: the [[containers|28 container spells]] whose 136 variant children are reskins by design.
...
| [[families/conjure|🧞 The Conjure Pair]] | <span class="tier tier-template">Shared template</span> | Conjure Elemental, Conjure Minor Elemental | 0.94 | CR bracket of the menu |
