...
<span class="tier tier-template">Shared template</span> · 10 spells · mechanical similarity 0.36–0.94
...
**What varies.** The rider (burning, prone, frightened, branded, blinded, staggered, banished, ensnared, thorned, shocked), the element, the action cost (bonus vs. action), and the level the rider is priced at. Branding, Banishing, and Ensnaring are themselves [[containers|containers]] with melee/ranged children.

**Design read.** Ten products from one on-hit engine — a pricing table for conditions, with the smite name as the flavor knob and the ranger versions as the same knob in a different aisle.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/bard|Bard]] · [[classes/paladin|Paladin]] · [[classes/ranger|Ranger]] · [[classes/warlock|Warlock]] · [[containers|Container Spells]] · [[families/imbues|The Imbue Shelf]] · [[findings|The Identical-Spell List]] · [[spells|All Spells, Tagged]]*
