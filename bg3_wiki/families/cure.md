...
<span class="tier tier-clone">Verbatim clone</span> · 7 spells · mechanical similarity 0.68–0.97
...
**What varies.** Delivery only: d8 touch action, d4 ranged bonus action, the multi-target versions of each, the flat-number top rung, and the per-turn drip.
