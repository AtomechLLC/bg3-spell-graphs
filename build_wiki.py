...
FAMILIES = [
 ...
 dict(slug="conjure-single", title="Conjure a Champion", tier=TEMPLATE,
  members=["conjure-elemental", "conjure-fey", "conjure-celestial", "planar-ally"],
  differs="creature type, CR cap, and what the summons costs you",
  shared="Summon a single powerful entity to fight for you: named type up to a CR cap, friendly, obeys commands, acts on its own initiative. Elemental vs. Fey masks to 0.814; Planar Ally is the same slot brokered through your deity.",
  varies="Creature type, CR cap, level (5–7), and the price of control — concentration with a hostile-escape clause (elemental), concentration with a polite exit (fey), or no concentration but a negotiated payment in gold (Planar Ally).",
  read="Sibling of [[families/conjure-table|Conjure by Menu]]: the same summoning contract at single-champion scale, with the danger-and-payment clause as the flavor differentiator."),
 ...
 dict(slug="phantom-armory", title="The Phantom Armory", tier=ENGINE,
  ...
  read="One shelf of the conjuration aisle: [[families/conjure-table|units by menu]], [[families/conjure-single|single champions]], [[families/undead|raised undead]], and here the objects and weapons — the summoning contract applied to things instead of creatures.",
 ),
...
function crumbHTML(slug, parts){
  let h = '<a href="#/overview">reskin codex</a>';
