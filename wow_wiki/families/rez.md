...
<span class="tier tier-clone">Verbatim clone</span> · 4 abilities · masked-tooltip similarity 0.50–1.00
...
**What varies.** The name and Rebirth's combat clause.

**Design read.** The clearest evidence that class kits were filled from a shared parts bin: death care is a franchise.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/druid|Druid]] · [[classes/paladin|Paladin]] · [[classes/priest|Priest]] · [[classes/shaman|Shaman]] · [[families/interrupts|The Interrupt Union]] · [[findings|The Identical-Spell List]] · [[overview|Overview]] · [[spells|All Abilities, Tagged]]*
