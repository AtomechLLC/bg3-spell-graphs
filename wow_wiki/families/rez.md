...
<span class="tier tier-clone">Verbatim clone</span> · 9 abilities · mechanical similarity 0.38–1.00
...
**What varies.** The name, Rebirth's combat clause, and the delivery — direct cast vs. the Soulstone's stored charge (with its tier ladder written into the item name).

**Design read.** The clearest evidence that class kits were filled from a shared parts bin: death care is a franchise, and the Warlock's branch sells it as a prepaid card.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/druid|Druid]] · [[classes/paladin|Paladin]] · [[classes/priest|Priest]] · [[classes/shaman|Shaman]] · [[classes/warlock|Warlock]] · [[families/conjured|The Conjured Commissary]] · [[families/interrupts|The Interrupt Union]] · [[findings|The Identical-Spell List]] · [[overview|Overview]] · [[spells|All Abilities, Tagged]]*
