...
|---|---|---|---|---|---|
| <img class="sic" data-i="enrage" alt=""> **Enrage** | Druid | 12 | Physical | 1 | $?a436895[Instantly generates X Rage and another ][Generates ]X rage over X$?p456328[][, but  reduces base arm |
...
| <img class="sic" data-i="feedback" alt=""> **Feedback** | Priest | 60 | Shadow | 5 | The priest becomes surrounded with anti-magic energy.  Any successful spell cast against the priest will burn  |
...
| <img class="sic" data-i="bloodrage" alt=""> **Bloodrage** | Warrior | 10 | Physical | 1 | Generates $/10;s1 rage at the cost of health, and then generates an additional $/10;29131o1 rage over X.  The  |
