...
<span class="tier tier-clone">Verbatim clone</span> · 5 abilities · mechanical similarity 0.38–0.85
...
**Design read.** Like [[families/rez|resurrection]], a cross-class utility franchise — every class got the same button with a different glove.
