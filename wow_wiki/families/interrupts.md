...
<span class="tier tier-clone">Verbatim clone</span> · 4 abilities · masked-tooltip similarity 0.58–0.88
...
**What varies.** The animation and the resource paying for it.

**Design read.** Like [[families/rez|resurrection]], a cross-class utility franchise — every melee got the same button with a different glove.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/rogue|Rogue]] · [[classes/shaman|Shaman]] · [[classes/warrior|Warrior]] · [[families/shocks|The Shock Battery]] · [[findings|The Identical-Spell List]] · [[overview|Overview]] · [[spells|All Abilities, Tagged]]*
