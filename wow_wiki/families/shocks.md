...
**What varies.** The element and the rider (interrupt / DoT / slow).

**Design read.** Three buttons, one circuit — and proof that the same design can be a 'school' variation in one class and an 'interrupt' clone in another.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/shaman|Shaman]] · [[findings|The Identical-Spell List]] · [[spells|All Abilities, Tagged]]*
