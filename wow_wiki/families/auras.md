# <span class="femoji">🛡️</span> The Aura Carousel

<span class="tier tier-template">Shared template</span> · 7 abilities · masked-tooltip similarity 0.65–1.00
...
**What varies.** The aura payload; one is active at a time — a modal dial like the Hunter's [[families/aspects|Aspects]].

**Design read.** The 'exclusive modal buff' engine — one slot, N interchangeable fillings — appears in four classes wearing four names: Auras, Aspects, Stances, Presences-to-be.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/paladin|Paladin]] · [[families/aspects|The Aspect Dial]] · [[families/curses|The Curse Catalogue]] · [[findings|The Identical-Spell List]] · [[spells|All Abilities, Tagged]]*
