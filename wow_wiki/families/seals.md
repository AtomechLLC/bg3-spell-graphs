...
|---|---|---|---|---|---|
| <img class="sic" data-i="judgement" alt=""> **Judgement** | Paladin | 4 | Holy | 1 | Unleashes the energy of a Seal spell upon an enemy.  Refer to individual Seals for Judgement effect. |
...
**What varies.** The proc payload and its judged counterpart.

**Design read.** A two-stage engine (seal + judgement) with six cartridges — the deepest template in the Paladin's warehouse.
