...
|---|---|---|---|---|---|
| <img class="sic" data-i="hurricane" alt=""> **Hurricane** | Druid | 60 | Nature | 3 | Creates a violent storm in the target area causing X Nature damage to enemies every X sec, and increasing the  |
| <img class="sic" data-i="volley" alt=""> **Volley** | Hunter | 58 | Arcane | 3 | Continuously fires a volley of ammo at the target area, causing X Arcane damage to enemy targets within X yard |
...
**Shared skeleton.** Damage that hits more than one target, in every delivery the game knows: the channeled rains (Blizzard / Rain of Fire / Hurricane / Volley — a four-class verbatim clone of one channel-the-sky design), the ground fields (Flamestrike / Consecration / Hellfire), the point-blank bursts (Arcane Explosion / Holy Nova / Thunder Clap / Blast Wave / Cone of Cold), the weapon sweeps (Whirlwind / Cleave / Multi-Shot), and the bounces (Chain Lightning — [[families/heals|Chain Heal]]'s hostile twin — and Holy Wrath).

**What varies.** School, shape (rain, field, nova, sweep, bounce), channel vs. instant, and the rider (slow, daze).

**Design read.** AoE damage as one product in five shapes — the rains alone are as tight a cross-class clone as the heals.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/druid|Druid]] · [[classes/hunter|Hunter]] · [[classes/mage|Mage]] · [[classes/paladin|Paladin]] · [[classes/priest|Priest]] · [[classes/shaman|Shaman]] · [[classes/warlock|Warlock]] · [[classes/warrior|Warrior]] · [[families/dots|The Affliction Engine]] · [[findings|The Identical-Spell List]] · [[spells|All Abilities, Tagged]]*
