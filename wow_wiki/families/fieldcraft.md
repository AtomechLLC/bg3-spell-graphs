...
**What varies.** The problem solved, the target (mind, lungs, lock, pocket, trap, vial), and the class stamp.

**Design read.** Downtime is a design space too — and even here the reskins run cross-class: both soothe spells and both breath spells are single auras sold twice.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/druid|Druid]] · [[classes/priest|Priest]] · [[classes/rogue|Rogue]] · [[classes/shaman|Shaman]] · [[classes/warlock|Warlock]] · [[findings|The Identical-Spell List]] · [[spells|All Abilities, Tagged]]*
