...
**What varies.** The payload: nature DoT, stat drain, or mana drain.

**Design read.** A three-round clip of the same dart — and the Scorpid/Curse of Weakness pair (0.70) shows the template leaking across classes into [[families/curses|Warlock curses]].
