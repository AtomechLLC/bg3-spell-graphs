# <span class="femoji">🐑</span> The Polymorph Barn

<span class="tier tier-clone">Verbatim clone</span> · 2 abilities · masked-tooltip similarity 0.96
...
**What varies.** The animal.

**Design read.** BG3 ships variant menus in a container; classic WoW sold them as loot. Same design, different economy.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/mage|Mage]] · [[findings|The Identical-Spell List]] · [[spells|All Abilities, Tagged]]*
