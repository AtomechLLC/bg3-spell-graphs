# <span class="femoji">🙌</span> The Greater Ladder

<span class="tier tier-template">Shared template</span> · 10 abilities · masked-tooltip similarity 0.32–1.00
...
| **Mark of the Wild** | Druid | 60 | Nature | 7 | Increases the friendly target's armor by X, all attributes by X and all resistances by X for X. |
...
| **Prayer of Fortitude** | Priest | 60 | Holy | 2 | Power infuses the target's party, increasing their Stamina by X for X. |
...
**Shared skeleton.** Stat buff on one target → the same buff on the party, renamed (Brilliance / Prayer of / Gift of) and given a reagent cost. Every pair measures ≥ 0.7 masked.

**What varies.** The delivery (single vs. group), the name prefix, and a reagent.

**Design read.** WoW's version of D&D's 'Mass' prefix — same design slot, same doubling, different naming convention per class.

Full list: [[findings|The Identical-Spell List]] · scoring: [[methodology|Methodology]]

---
*Linked from: [[classes/druid|Druid]] · [[classes/mage|Mage]] · [[classes/priest|Priest]] · [[families/aspects|The Aspect Dial]] · [[families/blessings|The Blessing Rack]] · [[families/teleports|The Hearth Network]] · [[findings|The Identical-Spell List]] · [[spells|All Abilities, Tagged]]*
