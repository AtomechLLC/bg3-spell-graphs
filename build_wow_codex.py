...
fam("bolts", "The Bolt Engine", ENGINE, "🏹",
    ["Fireball", "Pyroblast", "Frostbolt", "Shadow Bolt", "Wrath", "Starfire",
     ...
     "Chain Lightning", "Arcane Missiles", "Arcane Shot",
     "Searing Pain", "Conflagrate", "Exorcism", "Holy Wrath", "Hammer of Wrath"],
...
fam("aoe-damage", "The Area Barrage", TEMPLATE, "💥",
    ["Blizzard", "Rain of Fire", "Hurricane", "Volley", "Flamestrike", "Consecration",
     "Hellfire", "Arcane Explosion", "Holy Nova"],
    "the shape and school of the field",
    "Damage painted over an area: the channeled rains (Blizzard / Rain of Fire / Hurricane / Volley — a four-class verbatim clone of one channel-the-sky design), the ground fields (Flamestrike / Consecration / Hellfire), and the point-blank bursts (Arcane Explosion / Holy Nova).",
    "School, shape (rain, field, nova), channel vs. instant, and whether ticks or a burst deliver it.",
    "AoE damage as one product in three shapes — the rains alone are as tight a cross-class clone as the [[families/heals|heals]]."),
fam("melee-enhance", "The Whetstone & The Strike", TEMPLATE, "⚔️",
    ["Rockbiter Weapon", "Flametongue Weapon", "Frostbrand Weapon", "Windfury Weapon",
     "Mortal Strike", "Heroic Strike", "Slam", "Cleave", "Whirlwind", "Thunder Clap",
...
fam("snares", "The Slow Lane", TEMPLATE, "🥶",
    ["Entangling Roots", "Frost Nova", "Nature's Grasp", "Hamstring", "Wing Clip",
     "Concussive Shot", "Chilled", "Cone of Cold", "Blast Wave", "Frost Shock"],
