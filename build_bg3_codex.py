...
fam("conjure", "The Conjure Pair", TEMPLATE, "🧞",
    [rid("Conjure Elemental"), rid("Conjure Minor Elemental")],
    "CR bracket of the menu",
    "Summon a controllable elemental chosen from a menu; 0.94 signature similarity — and both are [[containers|containers]], with the menu implemented as child spells.",
    "The power bracket (mephits and azers vs. full elementals) and one spell level.",
    "The tabletop menu-summon template, with Larian's container system making the menu literal."),
