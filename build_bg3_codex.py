...
fam("cure", "The Cure Family", CLONE, "❤️‍🩹",
    ...
    "RegainHitPoints(XdY + modifier); the same healing engine as tabletop, ported intact. Cure Wounds vs. Healing Word measures 0.93 on mechanics; the whole family stays high. Heal is the top rung (a flat 70), and Warden of Vitality is the engine on a repeat timer — BG3's one heal-over-time, the WoW hots shelf reduced to a single SKU.",
    "Delivery only: d8 touch action, d4 ranged bonus action, the multi-target versions of each, the flat-number top rung, and the per-turn drip.",
...
fam("cc-misc", "The Control Ward", TEMPLATE, "🌀",
    [rid("Fear"), rid("Confusion"), rid("Command"), rid("Tasha's Hideous Laughter"),
     ...
     rid("Dissonant Whispers")],
    "the flavor of lost agency: panic, laughter, dance, blindness, madness, or exile",
...
fam("smites", "The Smite Armoury", TEMPLATE, "🔨",
    ...
    "rider condition and damage type; two are melee/ranged containers; three wear ranger green",
    ...
    "The rider (burning, prone, frightened, branded, blinded, staggered, banished, ensnared, thorned, shocked), the element, the action cost (bonus vs. action), and the level the rider is priced at. Branding, Banishing, and Ensnaring are themselves [[containers|containers]] with melee/ranged children.",
    "Ten products from one on-hit engine — a pricing table for conditions, with the smite name as the flavor knob and the ranger versions as the same knob in a different aisle."),
...
fam("touch-buffs", "The Touch-Buff Skeleton", ENGINE, "🤝",
    [rid("Longstrider"), rid("Enhance Leap"), rid("Grant Flight"), rid("Darkvision"),
     rid("Feather Fall"), rid("Freedom of Movement"), rid("Gaseous Form")],
    "the movement verb granted",
    "Touch a willing creature; apply a long-duration movement condition. Enhance Leap vs. Longstrider: 0.86 signature. Gaseous Form joins from the unfamilied list — same skeleton, with 'become a cloud' as the verb.",
...
fam("attack-cantrips", "The Damage Cantrip Engine", ENGINE, "🪄",
    [rid("Fire Bolt"), rid("Ray of Frost"), rid("Bone Chill"), rid("Shocking Grasp"),
     ...
     rid("Vicious Mockery"), rid("Booming Blade")],
    ...
    "The die (d4–d12), delivery (attack roll, save, or weapon swing), range, and the rider — slow, no-healing, pull, push, ignite, mock, boom.",
...
fam("protection", "The Protection Rack", TEMPLATE, "🛡️",
    [rid("Blur"), rid("Mirror Image"), rid("Blade Ward"), rid("Stoneskin"),
     ...
     rid("Sanctuary"), rid("Hellish Rebuke")],
    "the mitigation mechanism: miss me, halve it, resist it, survive it, wall it off, or bite back",
    "WoW's protection rack — armors, wards, absorbs, panic buttons — reassembled from BG3's unfamilied shelf. The miss-makers (Blur's disadvantage, Mirror Image's decoys), the halvers (Blade Ward, Stoneskin, Protection from Energy), the survival clauses (Death Ward's cheat-death, Warding Bond's damage-split), the retaliators (Fire Shield, Hellish Rebuke's reaction bite — WoW's Retaliation shelf), and the panic buttons (Globe of Invulnerability, Resilient Sphere, Sanctuary). The AC-stackers stay in the [[families/ac-wardrobe|Armour-Class Wardrobe]] — different mechanism, same aisle.",
...
fam("bolts", "The Bolt Rack", TEMPLATE, "🏹",
    ...
    "element, dice, and the rider stapled to the hit",
    ...
    "Element, dice, attack roll vs. auto-hit, and the rider (advantage, repeat damage, lingering tick, poison).",
